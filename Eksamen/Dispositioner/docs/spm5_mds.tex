...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item \todo{præcis mening med local id er endnu uvist...}Local ID, som skal bruges når den skal modtage, hvilket gør klassen uafhængig af global navngivning\footnote{Delvist svar, har indtil videre ikke kunne bestemme den nøjagtige grund.}.
	\end{itemize}
