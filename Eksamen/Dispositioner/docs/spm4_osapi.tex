...
I forhold til OS API'et bruger vi PIMPL idiomet til at pege på en anden implementering (I øvelsen er det windows implementeringen) alt efter hvilken platform vi befinder  os på - Altså en væsentlig del af OS API.
